...
module.exports = {
    ...
    async execute(client, message, args, Discord, errorlog, botlog, msglog, profileData) {
        ...
        if (!args.length) {
            ...
            if (guildProfile.MutePerm) embed.addField(`Mute Members Permision:`, `${guildProfile.MutePerm}`)
            if (guildProfile.CeasePerm) embed.addField(`Cease Permision:`, `${guildProfile.CeasePerm}`)
